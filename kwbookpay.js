...
if ($request.url.indexOf(path1) != -1){
	body = body.replace(/"type":\d*/g,'"type":2').replace(/"end":\d*/g, '"end":1835342000').replace(/"period":\d*/g, '"period":111').replace(/"bought_vip":\d*/g, '"bought_vip":1').replace(/"bought_vip_end":\d*/g, '"bought_vip_end":1835342000');
}else {
